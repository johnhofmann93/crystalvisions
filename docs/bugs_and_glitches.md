...
- [Graphics](#graphics)
  ...
  - [Wooper Well's stones use the wrong corner tile](#wooper-wells-stones-use-the-wrong-corner-tile)
...
### Wooper Well's stones use the wrong corner tile

This is a mistake with block $5B in the `johto_modern` tileset. The bottom-left corners of the three stones around Wooper Well use tile $4B, but should use tile $47.
