...
.DoSurge:
	...
	cp PLAYER_BIKE
	jr z, .do_dismount
	ld hl, MountSurgeScript
	call QueueScript
	ld a, $81
	ret
.do_dismount:
	ld hl, DismountSurgeScript
	call QueueScript
	ld a, $81
	ret
...
MountSurgeScript:
	...
	special UpdateTimePals
	callasm GetPartyNickname
	writetext MountSurgeText
	waitbutton
	closetext
	special MountSurgeEffect
	end
...
DismountSurgeScript:
	...
	special UpdateTimePals
	callasm GetPartyNickname
	writetext DismountSurgeText
	waitbutton
	closetext
	special DismountSurgeEffect
	end
