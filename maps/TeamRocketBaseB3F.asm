...
GruntF5Script:
	...
	waitbutton
	closetext
	setevent EVENT_LEARNED_WOOPERTAIL
	end
...
.Script:
	opentext
	checkevent EVENT_LEARNED_WOOPERTAIL
...
TeamRocketBaseB3F_MapEvents:
	...
	object_event 21,  7, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 0, WooperTailGrunt, EVENT_TEAM_ROCKET_BASE_POPULATION
