...
Route45ApricornTree:
	fruittree FRUITTREE_ROUTE_45_APRICORN
...
Route45_MapEvents:
	...
	object_event 14, 82, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route45ApricornTree, -1
