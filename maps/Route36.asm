...
Route36ApricornTree:
	fruittree FRUITTREE_ROUTE_36_APRICORN
...
Route36_MapEvents:
	...
	object_event 23,  4, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route36ApricornTree, -1
