...
EcruteakCity_MapEvents:
	...
	object_event 22, 27, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, EcruteakCityTeleporterScript, -1

EcruteakCityTeleporterScript:
	faceplayer
	opentext
	writetext EcruteakCityTeleporterText
	waitbutton
	closetext
	loadmenu EcruteakCityTeleporter_MenuHeader
	verticalmenu
	closewindow
	ifequal 1, .NewBark
...
EcruteakCityTeleporter_MenuHeader:
