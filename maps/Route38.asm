...
Route38ApricornTree:
	fruittree FRUITTREE_ROUTE_38_APRICORN
...
Route38_MapEvents:
	...
	object_event 14, 10, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route38ApricornTree, -1
