...
Route39ApricornTree:
	fruittree FRUITTREE_ROUTE_39_APRICORN
...
Route39_MapEvents:
	...
	object_event 11,  3, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route39ApricornTree, -1
