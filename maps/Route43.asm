...
Route43ApricornTree:
	fruittree FRUITTREE_ROUTE_43_APRICORN
...
Route43_MapEvents:
	...
	object_event  3, 26, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route43ApricornTree, -1
