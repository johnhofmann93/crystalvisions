...
Route44ApricornTree:
	fruittree FRUITTREE_ROUTE_44_APRICORN
...
Route44_MapEvents:
	...
	object_event 11,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route44ApricornTree, -1
