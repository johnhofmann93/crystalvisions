...
Route35ApricornTree:
	fruittree FRUITTREE_ROUTE_35_APRICORN
...
Route35_MapEvents:
	...
	object_event  4, 25, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route35ApricornTree, -1
