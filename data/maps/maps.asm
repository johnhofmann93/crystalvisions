...
MapGroup_Dungeons:
	...
	map WooperWellB1F, TILESET_CAVE, CAVE, LANDMARK_WOOPER_WELL, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map WooperWellB2F, TILESET_CAVE, CAVE, LANDMARK_WOOPER_WELL, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
...
MapGroup_Blackthorn:
	...
	map Route45, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_45, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
	map Route46, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_46, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BlackthornCity, TILESET_JOHTO_MODERN, TOWN, LANDMARK_BLACKTHORN_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map BlackthornMagnetTrainStation, TILESET_TRAIN_STATION, INDOOR, LANDMARK_BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_FastShip:
	...
	map CianwoodPort, TILESET_PORT, ROUTE, LANDMARK_CIANWOOD_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
