...
FalknerGroup:
	...
	db  7, SPEAROW,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db  9, FEAROW,  TACKLE, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 25, TOGEKISS,   GROWL, CHARM, METRONOME, SWEET_KISS
	db 26, HONCHKROW,  PECK, PURSUIT, FAINT_ATTACK, MEAN_LOOK
	db 27, MISMAGIUS,  GROWL, SPITE, CONFUSE_RAY, PSYBEAM
	db -1 ; end
...
BugsyGroup:
	...
	db 14, SPINARAK,     POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
...
YoungsterGroup:
	...
	db 21, FURRET,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, FURRET,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, FURRET,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
SchoolboyGroup:
	...
	db 32, SUNFLORA,    POISONPOWDER, VINE_WHIP, BIND, MEGA_DRAIN
...
BirdKeeperGroup:
	...
	db 38, FEAROW,    TOXIC, QUICK_ATTACK, WHIRLWIND, FLY
	db 38, FEAROW,    SWIFT, DETECT, STEEL_WING, FLY
	db -1 ; end

LassGroup:
	; LASS (1)
	db "CARRIE@", TRAINERTYPE_MOVES
	db 15, WYNAUT,     COUNTER, SPLASH, ENCORE, SAFEGUARD
	db 22, GLISCOR,    POISON_STING, SAND_ATTACK, QUICK_ATTACK, FAINT_ATTACK
	db 24, OVERQWIL,   TACKLE, POISON_STING, HARDEN, WATER_GUN
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 25, FEAROW,    SAND_ATTACK, QUICK_ATTACK, WHIRLWIND, WING_ATTACK
...
BeautyGroup:
	...
	db 20, AMBIPOM,    SCRATCH, SAND_ATTACK, SWIFT, THIEF
	db 21, YANMEGA,    TACKLE, SONICBOOM, DETECT, SWIFT
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, ARIADOS,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	...
	db 32, ARIADOS,   FURY_ATTACK, PURSUIT, TWINEEDLE, DOUBLE_TEAM
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 32, MUK,      WRAP, POISON_STING, BITE, GLARE
	...
	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 23, MUK,      WRAP, LEER, POISON_STING, BITE
...
BlueGroup:
	...
	db 56, FEAROW,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
...
GruntFGroup:
	...
	db 18, GRIMER,      WRAP, LEER, POISON_STING, BITE
