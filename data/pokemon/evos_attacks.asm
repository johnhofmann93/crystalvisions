...
BonslyEvosAttacks:
	db EVOLVE_HAPPINESS, TR_ANYTIME, SUDOWOODO
	db 0 ; no more evolutions
	db 1, ROCK_THROW
	db 1, MIMIC
	db 4, FLAIL
...
MisdreavusEvosAttacks:
	db EVOLVE_HAPPINESS, TR_ANYTIME, MISMAGIUS
	db 0 ; no more evolutions
	db 1, GROWL
	db 1, PSYWAVE
	db 6, SPITE
...
StantlerEvosAttacks:
	db EVOLVE_HAPPINESS, TR_ANYTIME, WYRDEER
	db 0 ; no more evolutions
	db 1, TACKLE
	db 8, LEER
	db 15, HYPNOSIS
