...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_ROUTE_35_APRICORN ; 1f
	const FRUITTREE_ROUTE_36_APRICORN ; 20
	const FRUITTREE_ROUTE_38_APRICORN ; 21
	const FRUITTREE_ROUTE_39_APRICORN ; 22
	const FRUITTREE_ROUTE_43_APRICORN ; 23
	const FRUITTREE_ROUTE_44_APRICORN ; 24
	const FRUITTREE_ROUTE_45_APRICORN ; 25
