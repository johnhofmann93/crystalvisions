...
; Johto story events
	...
	const EVENT_CLEARED_WOOPER_WELL
	...
	const EVENT_GOT_KINGS_ROCK_IN_WOOPER_WELL
...
; More Johto story events
	...
	const EVENT_LEARNED_WOOPERTAIL
...
; Johto itemballs
	...
	const EVENT_WOOPER_WELL_B1F_SUPER_POTION
	const EVENT_WOOPER_WELL_B2F_TM_RAIN_DANCE
...
; Johto people
	...
	const EVENT_AZALEA_TOWN_WOOPERS
	const EVENT_AZALEA_TOWN_WOOPERTAIL_ROCKET
	const EVENT_WOOPER_WELL_WOOPERS
	const EVENT_WOOPER_WELL_ROCKETS
	const EVENT_KURTS_HOUSE_WOOPER
...
; Kanto people
	...
	const EVENT_BLACKTHORN_TRAIN_STATION_POPULATION
